...
✨ **No Online Account Required** - Play with offline/cracked accounts without needing Mojang authentication  
...
Lapis supports 6 different renderers:

1. Holy GL4ES
2. Krypton Wrapper [NG_GL4ES](https://github.com/BZLZHH/NG-GL4ES)
3. The original Zink (Vulkan)
4. Zink (Kopper)
5. [MobileGlues](https://github.com/MobileGL-Dev/MobileGlues)
6. Large Thin Wrapper [LTW](https://github.com/MojoLauncher/LTW)

## Requirements

If you can run Amethyst, you meet the requirements.
...
5. Add your Minecraft Java Edition installation or download one through the launcher
...
5. Click **Play** to launch Minecraft Java Edition

## Offline Mode

This fork is specifically designed to work with offline/cracked accounts:
- No internet connection required for authentication
- Create custom player profiles with any username
- Perfect for local multiplayer via LAN

## Credits

- Original project: [Amethyst-Android](https://github.com/AngelAuraMC/Amethyst-Android)
- Minecraft is a trademark of Mojang Studios
- This project is for educational and personal use only

## Support & Contributing

For bug reports, feature requests, or contributions, please open an issue or pull request on this repository.

## Disclaimer

This project is a fan-made launcher and is not affiliated with Mojang Studios. Use at your own risk and respect Minecraft's terms of service.
